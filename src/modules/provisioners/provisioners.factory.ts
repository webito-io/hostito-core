...
export class ProvisionersFactory {
    ...
    get(provisionerName: ProvisionerType): ProvisionerProvider {
        switch (provisionerName) {
            case 'cpanel': return this.cpanelProvider;
            case 'directadmin': return this.directadminProvider;
            default: throw new BadRequestException(`Unknown provisioner: ${provisionerName}`);
        }
    }
}
